...
##Gameplay
In the Kitty Jungle, the player encounters new feral cats, and befriends them with careful pets. On every screen, there are two buttons: “pet” and “go to the next level.” At any time, the player can click “pet” to pet the cat, or “go to the next level” in order to meet the next cat. 
